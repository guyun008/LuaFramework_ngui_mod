...
public class UnityEngine_AnimationStateWrap
{
	...
	static int _CreateUnityEngine_AnimationState(IntPtr L)
	{
		...
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: UnityEngine.AnimationState.New");
		}
	...
	static int get_weight(IntPtr L)
	{
		...
		{
			return LuaDLL.luaL_error(L, obj == null ? "attempt to index weight on a nil value" : e.Message);
		}
	...
	static int get_normalizedTime(IntPtr L)
	{
		...
		try
		{
			ret = obj.normalizedTime;
		}
		catch(Exception e)
		{
			return LuaDLL.luaL_error(L, obj == null ? "attempt to index normalizedTime on a nil value" : e.Message);
		}
	...
	static int get_speed(IntPtr L)
	{
		...
		{
			return LuaDLL.luaL_error(L, obj == null ? "attempt to index speed on a nil value" : e.Message);
		}
	...
	static int get_normalizedSpeed(IntPtr L)
	{
		...
		try
		{
			ret = obj.normalizedSpeed;
		}
		catch(Exception e)
		{
			return LuaDLL.luaL_error(L, obj == null ? "attempt to index normalizedSpeed on a nil value" : e.Message);
		}
	...
	{
		UnityEngine.AnimationState obj = (UnityEngine.AnimationState)ToLua.ToObject(L, 1);
		UnityEngine.AnimationBlendMode ret;
	...
	{
		ToLua.PushOut<UnityEngine.AnimationState>(L, new LuaOut<UnityEngine.AnimationState>());
		return 1;
	}
}
